...
export class UserRoutes extends BaseRoute {
    constructor(
        @inject(Tokens.authController) private authController: IAuthController
    ) { super() }
    protected initRoute(): void {
        this.router
            ...
            .post('/otp/resend', (req: CustomRequest, res, next) => this.authController.resendOtp(req, res, next))
